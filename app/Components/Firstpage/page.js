...
import backimage from "../../../public/back-image.png"
    ...
    return (
        <section className="bg-white">
            <div className=" bg-linear-to-t from-gray-300 via-[#c1c1c1] to-gray-100  w-full h-auto">
                <div className="w-[80%] p-10 flex justify-between">
                    <div className=" flex  px-40 w-[100%] h-auto flex-col  ">

                        <h1 className=" mt-9  text-red-600 text-[32px]  text-right">قرعه‌کشی مصرف‌کنندگان گلستان</h1>

                        <p className=" text-black mt-5 text-[22px] ">
                            قرعه‌کشی دوره‌ای مصرف‌کنندگان چای گلستان</p>
                        <p className="w-[66%] my-5">
                    ...
                    <Image src={Image2} />
                    {/* <img src="/قرمز.png" alt="" className="w-full " /> */}
            ...
            <div className="w-[100%] bg-white p-[40px]">
                <div className="w-[100%] flex  justify-center items-center">
                    <div className=" w-[50%] flex flex-col">
                        ...
                        <p className="text-gray-400 text-justify flex flex-col gap-8 leading-8">
                        ...
                        <div className="mt-20">
                            ...
                            <p className="text-gray-400 line-clamp-4 text-justify leading-8  ">
                ...
                <div className="grid grid-cols-4 w-[60%] gap-5     mt-24 m-auto">
                    <div className="w-[100%] ">
                        <div className=" flex flex-col justify-center items-center gap-1">
                            <Image src={Statistics_4} className="" />
            ...
            <div className="bg-amber-200 w-full h-[630px] ">
                <div className="  w-full relative ">
                    <div className=" ">
                        <Image src={rice_img} className="w-full h-[100%]" />
                    </div>
                    <div className="bg-red-500 w-[15%] bottom-0 -translate-x-11/12 p-3 absolute ">
            ...
            <div className="bg-amber-200 w-full h-[630px] ">
                <div className=" relative w-full   ">
                    <div className="w-full h-[20%]">
                        <Image src={tea_img} className=" w-full" />
                    </div>
                    <div className="bg-red-500 w-[15%] bottom-0 -translate-x-11/12 p-3 absolute ">
            ...
            <div className="bg-amber-200 w-[100%] h-[630px] ">
                <div className=" relative w-full  ">
                    <div className="w-full h-[100%]">
                        <Image src={pistachio_img} className="w-full" />
                    </div>
                    <div className="bg-red-500 w-[15%] bottom-0 -translate-x-11/12 p-3 absolute ">
            ...
            <div className="bg-[#a2d19e] w-full flex justify-center">
                <div className="w-[60%]  p-18 flex gap-4   ">
                    {foodsobj.map((item, i) => (
                        <div className="card rounded-[1px]  bg-white w-[50%] shadow-sm" key={i}>
                            <figure>
                ...
                <div className="bg-[#02504e] w-full h-[97%] flex justify-center items-center ">
                    <div className="w-[100%] relative flex flex-col  items-center gap-3" >
                        ...
                        <div className="flex flex-col justify-center items-center">
                            ...
                            <Image src={hosp_image} className="absolute top-0 translate-y-27  shadow-2xl w-[360px] h-auto" />
                        </div>
                    </div>
                </div>
            ...
            <div className="w-full flex justify-center mt-7">
                <div className="w-[60%] flex flex-col gap-4 p-17">
                    <h1 className="text-red-500 font-bold">مسئوليت‌های اجتماعی گلستان</h1>
                    <p className="text-gray-500 leading-7">كسب‌وكارها اجزای قدرتمند جامعه به شمار می‌آیند و موفق‌ترین، قابل‌احترام‌ترین و مطلوب‌ترین كسب‌وكارها آنهایی هستند كه كاری فراتر از درآمدزایی ایجاد كنند؛‌ آنهایی كه آمده‌اند تا از تجربه و امکاناتشان برای حل مشكلات جامعه و محیط زندگی خود استفاده كنند. <span className="text-red-500 font-bold">گلستان</span> در فعالیت‌های‌ اجتماعی خود،‌ گسترده وسیعی از فعالیت‌های عام‌المنفعه را در دستوركار خود قرار داده است.

                    </p>
                    <button className="btn btn-outline rounded-[8px] text-gray-500 w-fit">اطلاعات بیشتر</button>
                </div>
